...
import 'package:etc_test_project/pages/kiosk/rss-test-pg.dart';
...
import 'ocr-test-pg.dart';

class OcrDemoPage extends StatefulWidget {
  OcrDemoPage({Key? key}) : super(key: key);

  @override
  _OcrDemoPageState createState() => _OcrDemoPageState();
}
