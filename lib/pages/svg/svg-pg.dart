...
class SvgMapChart extends StatefulWidget {
  @override
  _SvgMapChartState createState() => _SvgMapChartState();
}

class _SvgMapChartState extends State<SvgMapChart> {
  String _svgData = '';
  ...
  Future<void> _loadSvg() async {
    final svgString = await rootBundle.loadString('assets/ksia-ext-plan-min.svg');
    setState(() {
      _svgData = svgString;
    });
  }
  ...
  Widget build(BuildContext context) {
    return _svgData.isEmpty
        ...
        : Echarts(
            ...
            ''',
            extraScript: '''
            echarts.registerMap('ksia-ext-plan', { svg: `$_svgData` });
            ''',
